...
using Connections.Enums;
using Connections.Services.Interfaces;
...
namespace Connections.Controllers
{
    public class ContactsController : Controller
    {
        ...
        [HttpPost]
        [Authorize]
        public async Task<IActionResult> EmailContact(EmailContactViewModel emailContactViewModel)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    await _emailService.SendEmailAsync(emailContactViewModel.EmailData.EmailAddress, emailContactViewModel.EmailData.Subject, emailContactViewModel.EmailData.Body);
            ...
            return View(emailContactViewModel);
        }
        ...
        public async Task<IActionResult> Create()
        {
            ...
            ViewData["StatesList"] = new SelectList(Enum.GetValues(typeof(StatesAndProvinces)).Cast<StatesAndProvinces>().ToList());
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,BirthDate,Address1,Address2,City,StatesAndProvinces,PostalCode,Email,PhoneNumber,ImageFile")] Contact contact, List<int> CategoryList)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AppUserId,FirstName,LastName,BirthDate,Address1,Address2,City,StatesAndProvinces,PostalCode,Email,PhoneNumber,Created,ImageFile,ImageData,ImageType")] Contact contact, List<int> CategoryList)
        {
            if (id != contact.Id)
            {
                return NotFound();
